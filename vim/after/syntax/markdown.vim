...
syntax match markdownTaskP0 /^\s*- \[.\] P0\s.*$/ contains=markdownTaskP0Priority,@mkdNonListItem
syntax match markdownTaskP1 /^\s*- \[.\] P1\s.*$/ contains=markdownTaskP1Priority,@mkdNonListItem
syntax match markdownTaskP2 /^\s*- \[.\] P2\s.*$/ contains=markdownTaskP2Priority,@mkdNonListItem
